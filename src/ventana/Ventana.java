...
public class Ventana extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panel.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(292, 20, 90, -1));

        imagenUsuario.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Interface.png"))); // NOI18N
        panel.add(imagenUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 70, 250, 250));

        etiquetaUsuario.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 20)); // NOI18N
        etiquetaUsuario.setForeground(new java.awt.Color(255, 255, 255));
        etiquetaUsuario.setText("Usuario:");
        panel.add(etiquetaUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 350, -1, -1));

        etiquetaContraseña.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 20)); // NOI18N
        etiquetaContraseña.setForeground(new java.awt.Color(255, 255, 255));
        etiquetaContraseña.setText("Contraseña:");
        panel.add(etiquetaContraseña, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 400, -1, -1));
        ...
        panel.add(cajaUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 350, 230, 30));

        cajaContraseña.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        panel.add(cajaContraseña, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 400, 230, 30));
        ...
        panel.add(botonIniciarSesion, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 480, 120, 30));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        System.exit(0); //Hace que al presionar el botón salir nos saque del programa 
    ...
    private void botonIniciarSesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonIniciarSesionActionPerformed
        String usuarioCorrecto = "ricardo"; 
